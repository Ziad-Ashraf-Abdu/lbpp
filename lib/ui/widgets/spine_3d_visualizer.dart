...
import 'dart:math';
import 'package:vector_math/vector_math.dart' as vector; // Ensure vector_math is available
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF121212), // Darker background for better contrast
